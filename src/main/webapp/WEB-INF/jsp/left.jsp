...
<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
  <table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
    ...
    <tr valign="top">
      <td class="left_nav_bgshw" height="50">
        <p class="left_nav_link">
          ...
          <a href="user/selectUser" target="main">用户查询</a>
          </img>
        </p>
        <p class="left_nav_link">
          <img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;
          <a href="user/addUser?flag=1" target="main">添加用户</a>
          </img>
        </p>
      </td>
    </tr>
    ...
    <tr valign="top" id="submenu1" style="display: none">
      <td class="left_nav_bgshw" height="50">
        <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="dept/selectDept"
                                                                                            target="main">部门查询</a></img>
        </p>
        <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="dept/addDept?flag=1"
    ...
    <tr valign="top" id="submenu2" style="display: none">
      <td class="left_nav_bgshw" height="50">
        ...
        <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="job/addJob?flag=1"
    ...
    <tr valign="top">
      <td height="100%" align="center">
        <div class="copycct"><br/><strong>技术支持：</strong><br><strong>xxxxxxxx有限公司</strong><br>Http://www.deepsl.org</div>
      </td>
    </tr>
    <tr>
